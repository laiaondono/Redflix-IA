(define (domain dominioPlanificador)
	...
	(:functions
		(numAsignaciones ?d - dia) ;; numero de asignaciones de un dia
	)
	...
	(:action asignar_contenido
		...
		:effect (and  (tiene_contenido ?d) (asignado ?c) (asignacion ?c ?d) (increase (numAsignaciones ?d) 1))
	)
)